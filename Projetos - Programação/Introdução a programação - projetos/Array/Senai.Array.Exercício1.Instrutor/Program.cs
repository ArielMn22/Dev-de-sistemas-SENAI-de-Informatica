using System;
using Senai.Array.Exercício1.Classes;

namespace Senai.Array.AgendaViagens {
    class Program {
        static void Main (string[] args) {
            Passagem[] viagens = new Passagem[5];
            ...
            // Alocando
            while (i < 5) {
                viagens[i] = new Passagem (); // Instanciando no Heap;
                    ...
                    case "2":
                        {
                            if (i == 0) {
                                ...
                                while (j < i) {
                                    System.Console.WriteLine ("===============");
                                    System.Console.WriteLine ($"Passagem {j+1}: {viagens[j].Exibir()}");
                                    j++;
                                }
                            }
                            j = 0;
